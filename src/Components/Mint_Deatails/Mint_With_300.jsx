...
import { ULE_NFT_300, ULE_NFT_300_ABI, wireNftContractAbi, wireNftContractAddress } from '../../utilies/Bsc_contract';
                              ...
                              if (paused == false) {
                                  if (value < parseInt(maxLimitprTransaction)) {
                                      if (parseFloat(userBusdBalance) >= totalMintingPriceWire) {
                                          ...
                                          await wireContractOf.methods.approve(ULE_NFT_300, totalMintingPriceWire).send({
                                              from: acc
                                          })
                                          ...
                                          let walletOfOwner300 = await nftContractOf.methods.walletOfOwner(acc).call()
                                          let Price300=await nftContractOf.methods.MinitngPricein_token().call()
