...
import { ULE_NFT_4000, ULE_NFT_4000_ABI, wireNftContractAbi, wireNftContractAddress } from '../../utilies/Bsc_contract';
                              ...
                              if (paused == false) {
                                  if (value < parseInt(maxLimitprTransaction)) {
                                      if (parseFloat(userBusdBalance) >= totalMintingPriceWire) {
                                          ...
                                          await wireContractOf.methods.approve(ULE_NFT_4000, totalMintingPriceWire).send({
                                              from: acc
                                          })
