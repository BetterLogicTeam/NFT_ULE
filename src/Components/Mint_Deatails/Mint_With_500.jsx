...
import { ULE_NFT_500, ULE_NFT_500_ABI, wireNftContractAbi, wireNftContractAddress } from '../../utilies/Bsc_contract';
                ...
                // if (res == 1) {
                    try {
                        ...
                        if (value > totalnft) {
                            ...
                            mintingWirePrice = parseFloat(mintingWirePrice.data.data*5);
                                ...
                                if (paused == false) {
                                    if (value < parseInt(maxLimitprTransaction)) {
                                        if (parseFloat(userBusdBalance) >= totalMintingPriceWire) {
                                            ...
                                            await wireContractOf.methods.approve(ULE_NFT_500, totalMintingPriceWire).send({
                                                from: acc
                                            })
                                            ...
                                            let walletOfOwner500 = await nftContractOf.methods.walletOfOwner(acc).call()
